...
const details = [
  {
    ...
    details:
      "Ми розмістимо Ваш логотип на бренд-воллі, великому банері з логотипами всіх партнерів заходу, що буде демонструватися під час події, що забезпечить додаткову видимість Вашого бренду.",
  },
  {
    heading: "Промоція в 2 Instagram story",
    details:
      "Розміщення інформації про Вашу компанію в 2 Instagram story в Instagram-профілі @best_lviv після завершення події.",
  },
  {
  ...
  },
  {
    ...
    details:
      "На місці проведення змагань будуть транслюватися відеоролики компаній. Необхідні відеоматеріали тривалістю до 1 хв надає компанія-учасник.",
  },
  {
    ...
    <div className="flex w-full justify-center container">
      <div className="text-neutral-50 bg-[#222227] relative border border-red-500 rounded-lg px-5 py-4 basis-[700px]">
        <Dialog>
          <DialogTrigger asChild>
            <Button
              ...
              onClick={() =>
                handleModal({
                  name: "Деталі пропозиції",
                  modalData: details as dataItem[],
                })
              }
            >
              <Info
                strokeWidth={1.5}
                className="hover:bg-gray-600 rounded-full transition"
              />
            </Button>
          </DialogTrigger>
          <Modal />
        ...
        <h3 className="text-2xl md:text-4xl font-extralight">
          За Вашу продукцію ми надамо
        </h3>

        <div className="text-md space-y-3 mt-5">
          <div className="flex gap-2">
            <Check className="flex-shrink-0 " strokeWidth={3} width={19} />
            <p className="text-md font-medium ">Лого на бренд-волл</p>
          </div>
          <div className="flex gap-2">
            <Check className="flex-shrink-0 " strokeWidth={3} width={19} />
            <p className="text-md font-medium ">Промоція в 2 Instagram story</p>
          </div>
          <div className="flex gap-2">
            <Check className="flex-shrink-0 " strokeWidth={3} width={19} />
