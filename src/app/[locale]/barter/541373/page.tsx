...
const details = [
  {
    ...
    details:
      "Розміщення інформації про Вашу компанію в 1 Instagram story в Instagram-профілі @best_lviv після завершення події.",
  },
  {
      ...
      <div className="text-neutral-50 bg-[#222227] relative border border-red-500 rounded-lg px-5 py-4 basis-[700px]">
        ...
        <div className="text-md space-y-3 mt-5">
          <div className="flex gap-2">
            ...
            <p className="text-md font-medium ">Промоція в 1 Instagram story</p>
          </div>{" "}
          <div className="flex gap-2">
            <Check className="flex-shrink-0 " strokeWidth={3} width={19} />
